...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-purple-200 flex flex-col items-center text-center px-4 sm:px-6 overflow-x-hidden">
      ...
      <motion.div
        className="absolute left-4 sm:left-20 top-[200px] sm:top-[275px]"
        initial={{ y: 0 }}
        animate={{ y: showGlimpse ? 275 : 0 }}
        transition={{ duration: 1, ease: "easeInOut" }}
      >
        <p className="text-4xl sm:text-7xl font-semibold text-black-600 text-left font-vollkorn">
      ...
      <motion.div
        className="absolute left-4 sm:left-20 top-[300px] sm:top-[400px]"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-10">
          <Image
            ...
            width={180}
            height={200}
            className="w-[120px] h-[140px] sm:w-[180px] sm:h-[200px] object-cover rounded-xl shadow-lg"
          />
          <p className="text-lg sm:text-2xl leading-relaxed sm:leading-[2.5] font-semibold text-gray-900 text-left font-work-sans">
      ...
      {showArrow && (
        <motion.div
          className="fixed bottom-[50px] right-4 sm:right-10 text-gray-600"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div id="current-pursuits-title" className="mt-[100vh] mb-16 sm:mb-32 text-gray-600">
        <h2
          style={{
            color,
          ...
          className="absolute left-4 sm:left-20 text-5xl sm:text-9xl font-bold text-center font-vollkorn transition-all duration-500"
        >
          current pursuits
        </h2>
      </div>

      <div className="mt-16 px-4 sm:px-10 w-full text-gray-800 space-y-16">
        {/* HackSC Section */}
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-10">
          <Image
            src="/hacksc.png"
            ...
            width={450}
            height={150}
            className="w-full sm:w-[450px] h-[150px] rounded-lg shadow-md"
          />
          <div>
            <h3 className="text-3xl sm:text-5xl text-left sm:text-right font-bold text-black font-vollkorn">
              experience coordinator @ hackSC
            </h3>
            <p className="text-lg sm:text-2xl text-left sm:text-right mt-4 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-10">
          <div>
            <h3 className="text-3xl sm:text-5xl text-left font-bold text-black font-vollkorn">
              personal projects @ USC
            </h3>
            <p className="text-lg sm:text-2xl text-left mt-4 leading-relaxed">
